...
export function Footer() {
  ...
  const services = [
    { name: "Cancer Care", href: "/services/cancer-care" },
    { name: "Labor & Delivery", href: "/services/labor-delivery" },
    { name: "Heart & Vascular", href: "/services/heart-vascular" },
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">© 2024 DOCSPOT. All rights reserved. Designed with ❤️ for better healthcare.</p>
        </div>
      </div>
    </footer>
  )
